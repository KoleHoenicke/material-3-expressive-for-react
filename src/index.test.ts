...
describe('public package surface', () => {
  it('exports short and explicit component names', () => {
    ...
    expect(library.AlertDialog).toBe(library.MaterialAlertDialog)
    expect(library.BasicAlertDialog).toBe(library.MaterialBasicDialog)
    expect(library.FullScreenDialog).toBe(library.MaterialFullScreenDialog)
    expect(library.Menu).toBe(library.MaterialMenu)
    expect(library.DropdownMenu).toBe(library.MaterialMenu)
    expect(library.DropdownMenuPopup).toBe(library.MaterialMenu)
    expect(library.MenuItem).toBe(library.MaterialMenuItem)
    expect(library.DropdownMenuItem).toBe(library.MaterialMenuItem)
    expect(library.MenuGroup).toBe(library.MaterialMenuGroup)
    expect(library.DropdownMenuGroup).toBe(library.MaterialMenuGroup)
    expect(library.CheckableDropdownMenuItem).toBe(library.MaterialCheckableMenuItem)
    expect(library.SelectableDropdownMenuItem).toBe(library.MaterialSelectableMenuItem)
